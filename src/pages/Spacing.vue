    ...
    <section class="q-mb-xl">
      ...
      <div class="bg-primary q-pa-xs">
        <div class="bg-dark text-white">
          ...
          id possimus distinctio autem eligendi nam ipsum, facere, reiciendis
          aliquid ab veritatis perspiciatis nesciunt repellat inventore dolore.
          Maiores commodi quis rem.
        </div>
      </div>
      ...
      <div
        class="bg-primary q-mt-md flex items-center justify-center"
